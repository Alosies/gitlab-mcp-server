  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        since: {
          type: 'string',
          description: 'ISO 8601 date format (YYYY-MM-DDTHH:MM:SSZ) - commits after this date',
        },
        until: {
          type: 'string',
          description: 'ISO 8601 date format (YYYY-MM-DDTHH:MM:SSZ) - commits before this date',
        },
        author: {
          type: 'string',
